...
* `Combine Data Before Saving:` Instead of creating individual files for each indicator, stores the data frames in memory and combines them after all indicators have been downloaded.
